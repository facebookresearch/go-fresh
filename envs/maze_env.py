...
class MazeWrapper(BaseWrapper):
    ...
    def plot_values(self, rnet_model, comp_obs, comp_state, obss, states,
            pos=False, sigmoid=False):
    ...
    def plot_embeddings(self, rnet_model, obss, states, show_colors=True,
            title=None):
